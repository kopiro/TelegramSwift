...
2. Change bundle Identifier and team-id. Easiest way is to search all mentions `com.kopiro.Telegram` and change it to your own. Team-id you can find on apple developer portal.
